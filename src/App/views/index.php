...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    ...
    <form method="GET" class="mt-4 w-full">
        <div class="flex">
            <input value="<?php echo escape((string) $searchTerm);
                            ?>" name="s" type="text" class="w-full rounded-l-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter search term" />
            ...
            ?>
                <tr>
                    ...
                    <td class="p-4 text-sm text-gray-600">
                        ...
                        ?>
                            <div class="inline-block relative cursor-pointer">
                                <a href="/transaction/<?php echo escape($transaction['id']);
                                                        ?>/receipt/<?php echo escape($receipt['id']);
                                                                    ?>">
                                ...
                                <form action="/transaction/<?php echo escape($transaction['id']);
                                                            ?>/receipt/<?php echo escape($receipt['id']);
                                                                        ?>" method="POST">
                    ...
                    <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                        <a href="/transaction/<?php echo escape($transaction['id']);
                                                ?>/receipt" class="p-2 bg-amber-50 text-xs text-amber-900 hover:bg-amber-500 hover:text-white transition rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="-mt-px flex w-0 flex-1">
            ...
            ?>
                <a href="/?<?php echo escape($previousPageQuery);
        ...
        <div class="hidden md:-mt-px md:flex">
            ...
            ?>
                <a href="/?<?php echo escape($query);
                            ?>" class="<?php echo $pageNum + 1 === $currentPage ? "border-indigo-500 text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300";
        ...
        <div class="-mt-px flex w-0 flex-1 justify-end">
            ...
            ?>
                <a href="/?<?php echo escape($nextPageQuery);
