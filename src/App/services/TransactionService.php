...
class TransactionService
{
    ...
    {
        $searchTerme = addcslashes($_GET['s'] ?? '', '%_');
        $params = [
            'user_id' => $_SESSION['user'],
            'description' => "%{$searchTerme}%"
        ];
        ...
        //@ We use array map to find each transaction receipt from receipts database
    ...
    public function getUserSingleTransaction(string $id)
    {
